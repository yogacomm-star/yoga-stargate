  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        onClick={buy}
        disabled={loading}
        className="mt-1 cursor-pointer rounded-full bg-accent px-5 py-2 text-sm font-semibold text-accent-foreground shadow-soft-sm transition-transform hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-60"
      >
